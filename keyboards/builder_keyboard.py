...
async def builder_main_menu() -> ReplyKeyboardMarkup:
...
async def builder_for_delete_notes() -> ReplyKeyboardMarkup:
...
async def builder_for_show_notes() -> ReplyKeyboardMarkup:
